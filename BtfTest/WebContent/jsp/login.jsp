	...
	<div class="form">
		<form name="loginForm" validate="validate" action="<%=path %>/LoginServlet" method="post">		
			<table class="main-container">
				...
				<tr>
					<td colspan="2">
						<div class="group-inputs">
							<input type="text" class="input-wrapper" id="username" name="username" placeholder="手机号或邮箱" required="required" autofocus value="${account }">
				...
				<tr>
					<td>
						<a href="<%=path %>/jsp/register.jsp"  class="nav-slider right-side">注册</a>
					</td>
					<td>
